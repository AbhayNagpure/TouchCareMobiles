...
import { Home, Store, Shield, LogOut, ChevronDown, MoreVertical, PhoneCall } from 'lucide-react';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-1 md:gap-2">
              ...
              {/* 3-dot menu for Theme & Language (Both Desktop & Mobile) */}
              ...
              {/* Auth Button / Profile Dropdown (Both Desktop & Mobile) */}
              {user ? (
